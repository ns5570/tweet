...
function SearchForm({ classes, searchUser }) {
  ...
  const handleSubmit = (e) => {
    ...
    if (e.key === 'Enter') {
      searchUser(searchData, navigate); // Use navigate to change the route
    }
  };
...
export default connect(null, { searchUser })(withStyles(styles)(SearchForm));
